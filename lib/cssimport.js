...
(function() {
  ...
  found_css_dep = function found_css_dep(orig, ext, path) {
    var _this = this;
    return function(cb) {
  ...
  scan_code = function scan_code(code, ext, filename, cb) {
    var dir, file, funcs, imports, matches, path, _i, _len, _ref, _ref2,
      _this = this;
    ext = '.' + ext.replace(/^\./, '');
