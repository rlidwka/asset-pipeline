...
(function() {
  ...
  DepsManager = (function() {
    ...
    DepsManager.prototype._checkFile = function _checkFile(file, cb) {
      ...
      if (this.files[path] == null) return cb(null, true);
      if (this.files[path].mtime == null) return cb(null, true);
      ...
      return fs.stat(path, function(err, res) {
        var changed, newtime, _cb, _i, _j, _k, _len, _len2, _len3, _ref, _ref2, _ref3;
        ...
        _ref3 = _this.fs_stat_queue[path];
    ...
    DepsManager.prototype.mtime = function mtime(file) {
      var _ref;
