...
(function() {
  ...
  Pipeline = (function() {
    ...
    function Pipeline(options, plugins) {
      var file, server, _base, _base1, _base2, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5,
        _this = this;
      ...
      server = function server(set_maxage) {
        if (set_maxage == null) {
          set_maxage = false;
        }
    ...
    Pipeline.prototype.serve_file = function serve_file(req, res, file, server, next) {
