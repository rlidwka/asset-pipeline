...
(function() {
  var DepMgr, Inlines, MakePath, Path, Pipeline, Send, URL, async, cleanCSS, crypto, fs, uglify, uglify_jsp, uglify_pro, util;
  ...
  Pipeline = (function() {
    ...
    function Pipeline(options, plugins) {
      var file, server, _base, _base1, _base2, _base3, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6,
        _this = this;
      ...
      if ((_ref3 = (_base3 = this.options).minify) == null) {
        _base3.minify = [];
      }
      this.options.minify = this.options.minify.map(function(x) {
        if (x[0] === '.') {
          return x;
        } else {
          return '.' + x;
      ...
      this.depmgr.min_check_time = (_ref4 = this.options.min_check_time) != null ? _ref4 : 1000;
      ...
      _ref6 = (_ref5 = this.options.files) != null ? _ref5 : [];
    ...
    Pipeline.prototype.serve_file = function(req, res, file, server, next) {
      var file_defined, _base, _ref, _ref1,
        _this = this;
    ...
    Pipeline.prototype.send_to_pipeline = function(reqfile, file, plugins, cb) {
      ...
      return fs.readFile(file, function(err, data) {
        ...
        return _this.actual_pipeline(data, plugins, file, {
          ...
          ext = "." + dest.split(".").pop();
          if (_this.options.minify.indexOf(ext) !== -1) {
            if (ext === ".js") {
              ast = uglify_jsp.parse(data);
              if (_this.options.jsMangle === true) {
                ast = uglify_pro.ast_mangle(ast);
              }
              if (_this.options.jsSqueeze === true) {
                ast = uglify_pro.ast_squeeze(ast);
              }
              if (_this.options.jsLift === true) {
